...
This is the Claude Code user-scope wrapper for the shared `make-html` skill.
...
Do not answer from this wrapper alone. The wrapper exists only so Claude Code can discover the skill globally while Cursor remains the editable source of truth.
